...
export const metadata: Metadata = {
  ...
  description: "Get in touch with Daksham Developers for premium real estate advisory.",
};
          ...
          <div className="space-y-8 sm:space-y-10 md:space-y-12">
            <FadeIn delay={0.2} direction="right">
              <div className="rounded-2xl sm:rounded-3xl border border-border-light bg-white p-6 sm:p-8 md:p-10 shadow-xl shadow-navy/5">
                <h2 className="mb-6 sm:mb-8 font-display text-2xl sm:text-3xl font-medium uppercase tracking-wide text-navy">Reach Out</h2>
                <div className="space-y-6 sm:space-y-8">
                  <div className="flex items-start group">
                    ...
                    <div className="ml-4 sm:ml-6">
                      <h3 className="font-sans text-xs sm:text-sm font-bold uppercase tracking-wider text-navy">Office Address</h3>
                  ...
                  <div className="flex items-start group">
                    ...
                    <div className="ml-4 sm:ml-6">
                      <h3 className="font-sans text-xs sm:text-sm font-bold uppercase tracking-wider text-navy">Phone</h3>
                      <p className="mt-1.5 sm:mt-2 font-sans text-muted text-sm">
                        <a href="tel:+919876543210" className="hover:text-cyan transition-colors">+91 98765 43210</a>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start group">
                    ...
                    <div className="ml-4 sm:ml-6">
                      <h3 className="font-sans text-xs sm:text-sm font-bold uppercase tracking-wider text-navy">Email</h3>
                      <p className="mt-1.5 sm:mt-2 font-sans text-muted text-sm">
                        <a href="mailto:info@dakshamdevelopers.com" className="hover:text-cyan transition-colors">info@dakshamdevelopers.com</a>
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <FadeIn delay={0.4} direction="right">
              <div className="h-[250px] sm:h-[300px] md:h-[400px] w-full overflow-hidden rounded-2xl sm:rounded-3xl border border-border-light bg-off-white shadow-sm">
                <iframe
          ...
          <div className="lg:pl-4 xl:pl-8">
            <FadeIn delay={0.3} direction="left">
              <div className="mb-6 sm:mb-8">
                <h2 className="font-display text-2xl sm:text-3xl font-medium uppercase tracking-wide text-navy">Send an Enquiry</h2>
