...
const badges = [
  { icon: <Mail size={20} />, href: "mailto:dakshamdevelopers@gmail.com", bg: "bg-navy-light", glow: "shadow-navy-light/30", delay: 0.2, name: "Email" },
  { icon: <Phone size={20} />, href: "tel:+919653307030", bg: "gold-gradient", glow: "shadow-gold/30", delay: 0.3, name: "Call Us" },
