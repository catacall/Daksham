    ...
    <>
      ...
      >
        <div className="container mx-auto px-6 sm:px-12 lg:px-20 max-w-7xl">
          ...
          >
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display gold-gradient-text-gradient font-black uppercase tracking-wide leading-[1.1] max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-navy rounded-[3rem] border border-transparent shadow-[0_20px_50px_rgba(0,0,0,0.3)] px-8 py-16 sm:px-16 sm:py-24 relative overflow-hidden group"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
              ...
              <div className="mt-16 sm:mt-24 text-center max-w-4xl mx-auto relative z-10">
                <h3 className="gold-gradient-text font-display text-2xl sm:text-3xl md:text-4xl font-bold uppercase tracking-wide mb-6">
                ...
                <p className="font-sans text-white text-base sm:text-lg leading-relaxed max-w-3xl mx-auto">
                  ...
                  , we deliver that stand as testaments to quality.
                  <strong className="gold-gradient-text font-bold">
                    customer-centric vision
                  </strong>{" "}
                  Guided by a , our joint ventures ensure uncompromised
                  excellence in every square foot we construct.
                </p>
              </div>
            </div>
          </motion.div>
