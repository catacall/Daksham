  ...
  return (
    <section id="about" className="py-16 sm:py-24 md:py-32 bg-off-white relative z-10">
      <div className="container mx-auto px-6 sm:px-12 lg:px-20 max-w-7xl">
        ...
        >
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display text-navy font-black uppercase tracking-wide leading-[1.25] max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="max-w-5xl relative z-10 mx-auto text-center lg:text-left">
            <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-medium text-white tracking-wide leading-snug mb-14">
