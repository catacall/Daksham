...
export default function Footer() {
  return (
    <>
      ...
      <footer className="bg-slate-600/50 text-gold py-10 md:py-16">
        <div className="container mx-auto px-5 sm:px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            <h4 className="font-bold font-sans mb-4 md:mb-6 tracking-widest text-lg uppercase text-gold">
              Quick Links
            </h4>
          ...
          <div>
            ...
            <div className="flex flex-col gap-5 text-white text-lg font-sans tracking-wide leading-loose">
              <div>
                <span className="font-bold font-sans text-base uppercase tracking-widest block text-gold mb-2">
                  Corporate Office
                </span>
                <a
        ...
        <div className="container mx-auto px-5 sm:px-6 mt-10 md:mt-16 pt-8 border-t border-gold/20 flex flex-col md:flex-row justify-between items-center gap-6 text-white text-base font-sans tracking-wide">
